    ...
    <>
        ...
        <div className="main-container_footer">
          ...
          <div className="main-footer__row main-footer__row-2">
            ...
            <div className="main-footer__row main-footer__row-1">
              ...
              <h2 className="social_head">SOCIAL</h2>
                ...
                <a href="https://www.linkedin.com/in/aftabahmed1311/">
                ...
                <a href="https://github.com/Aftab1311">
                ...
                <a  href="https://twitter.com/MysticalAftab">
                ...
                <a  href="https://www.youtube.com/channel/UCKlNOKs148Wh1vpMk5NcMtQ">
          ...
          <div className="main-footer__lower">
            © Copyright
            2023. Made by &nbsp;
            <a  href="https://twitter.com/MysticalAftab"> Aftab Ahmed</a>
          </div>
        </div>
      </footer>
    </>
